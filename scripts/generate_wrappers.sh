...
# НОВАЯ СТРАНИЦА: АУДИО ПЛЕЕР
gen_ev "audit_audio.html" "УЛИКА: Аудио-протокол Audit 9600" "#00c6ff" "Звуковая фиксация процесса аудита." '<audio controls style="width:100%;"><source src="audit_9600.mp3" type="audio/mpeg">Браузер не поддерживает плеер.</audio>'

# ГЛАВНАЯ (Обновленная с 4 кнопками)
cat <<HTML > index.html
<!DOCTYPE html>
<html lang="ro">
...
<style>
    ...
    .btn-red{background:#ff0000;color:#fff;} .btn-gold{background:#ffcc00;color:#000;} .btn-blue{background:#00c6ff;color:#000;}
</style></head>
<body><div class="vault">
    ...
    <a href="audit_audio.html" class="btn btn-blue">🎙️ АУДИО-АУДИТ 9600</a>
    <br><br>
