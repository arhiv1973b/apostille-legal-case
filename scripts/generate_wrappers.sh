...
gen_ev "torture_2003_evidence.html" "УЛИКА: Пытки (2003)" "#ff6600" "Доказательство истязаний." '<embed src="torture_2003_evidence.pdf" type="application/pdf" width="100%" height="700px">'
...
gen_ev "signed_audit_evidence.html" "УЛИКА: Подписанный Реестр" "#00ffff" "Верифицированный аудит дефектных апостилей." '<embed src="apostille_signed_audit.pdf" type="application/pdf" width="100%" height="700px">'
gen_ev "un_petition_evidence.html" "EVIDENCE: UN OHCHR" "#ffcc00" "Регистрация в ООН." '<embed src="un_petition_urgent.pdf" type="application/pdf" width="100%" height="700px">'
...
<style>
    ...
    .btn-red{background:#ff0000;color:#fff;} .btn-gold{background:#ffcc00;color:#000;} .btn-blue{background:#00c6ff;color:#000;} .btn-root{background:#ff00ff;color:#fff;} .btn-cyan{background:#00ffff;color:#000;}
</style></head>
<body><div class="vault">
    <h1>Pârât: Ministerul Finanțelor RM</h1>
    <div class="critical">⚖️ LEGEA 1545/1995: ПУНКТЫ A, B, C, F | НИЧТОЖНОСТЬ АКТОВ</div>
    <hr style="border:0;border-top:1px solid #00ff00;">
    
    <a href="origin_1997_evidence.html" class="btn btn-root">🛡️ №0: КОРЕНЬ (1997)</a>
    <a href="torture_2003_evidence.html" class="btn" style="background:#ff6600; color:#fff;">🔥 №2003: ПЫТКИ</a>
    <a href="disability_evidence.html" class="btn btn-red">🚑 ИНВАЛИДНОСТЬ</a>
    <a href="signed_audit_evidence.html" class="btn btn-cyan">📑 SIGNED AUDIT</a>
